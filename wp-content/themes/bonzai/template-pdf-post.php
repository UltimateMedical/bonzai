 ...
 <div class="bg-ultra-light pd-t-30 pd-b-40">
	 <div class="card pd-t-10 pd-b-10 pd-l-10 pd-r-10" style="width: 30rem; max-width: 100%; margin:auto;">
	  ...
	  <div class="card-body">
	  	...
	  	<a href="<?php echo the_field("pdf_url"); ?>" target="_blank" class="btn bg-green color-white btn-lg btn-block mg-t-20 mg-b-20">Visit</a>
	  	<hr style="" />

	    <h5 class="card-title color-grey"> <?php the_title(); ?> <small style="float:right"><i class="fa fa-file-pdf-o"></i> PDF</small></h5>
